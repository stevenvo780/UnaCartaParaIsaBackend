...
import { BiomeResolver } from '../generation/BiomeResolver.js';
import { WorldGenConfig, TerrainTile, BiomeType } from '../generation/types.js';
import { SIMPLE_BIOMES, SimpleBiomeConfig } from '../generation/SimpleBiomeDefinitions.js';
...
export class WorldGenerationService {
  ...
  private initializeGenerators(config: WorldGenConfig) {

/**
 * Sprite key enumerations for the simulation system.
 *
 * Defines all sprite keys used for rendering various entities and zones.
 *
 * @module shared/constants/SpriteEnums
 */

/**
 * Enumeration of sprite keys for zones/buildings.
 */
export enum ZoneSpriteKey {

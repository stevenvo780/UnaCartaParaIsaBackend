...
export type SimulationCommand =
  ...
  | { type: "NEEDS_COMMAND"; command: "SATISFY_NEED" | "MODIFY_NEED" | "UPDATE_CONFIG"; payload?: Record<string, unknown> }
  | { type: "RECIPE_COMMAND"; command: "TEACH_RECIPE" | "SHARE_RECIPE"; payload?: Record<string, unknown> }
  | { type: "SOCIAL_COMMAND"; command: "IMPOSE_TRUCE" | "SET_AFFINITY" | "MODIFY_AFFINITY" | "FRIENDLY_INTERACTION" | "HOSTILE_ENCOUNTER" | "REMOVE_RELATIONSHIPS"; payload?: Record<string, unknown> }
  | { type: "RESEARCH_COMMAND"; command: "INITIALIZE_LINEAGE" | "RECIPE_DISCOVERED"; payload?: Record<string, unknown> }
